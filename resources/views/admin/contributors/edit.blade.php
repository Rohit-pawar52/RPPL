...
@section('content')
    ...
    <div class="max-w-lg rounded-lg border border-neutral-200 bg-white p-4">
        <form method="POST" action="{{ route('admin.contributors.update', $contributor) }}" enctype="multipart/form-data" novalidate>
            @csrf
            @method('PUT')
            ...
            <div class="mt-2 flex items-center gap-2">
                ...
                <a href="{{ route('admin.contributors.index') }}" class="rounded-md border border-neutral-200 px-3 py-2 text-[13px] font-medium text-neutral-600 hover:bg-neutral-50">
                    Cancel
                </a>
            </div>
        </form>
