            ...
            <form method="POST" action="{{ route('admin.matches.innings.deliveries.store', [$match, $innings]) }}" novalidate>
                ...
                <div class="mb-3.5">
                    ...
                    <textarea
                        ...
                        name="commentary"
                        rows="2"
                        class="w-full rounded-md border px-3 py-2 text-[13px] focus:outline-none focus:ring-2 {{ $errors->has('commentary') ? 'border-red-400 focus:ring-red-100' : 'border-neutral-300 focus:ring-blue-100' }}"
                ...
                <button type="submit" class="rounded-md bg-blue-600 px-4 py-2 text-[13px] font-medium text-white hover:bg-blue-500">
                    Record Delivery
                </button>
            </form>
        </div>
